# gin — Internal security scan summary
...
**Raw artifacts:** `artifacts/gin/{osv-scanner,syft,trivy,gitleaks,trufflehog,opengrep,clamav}/`
...
Identical scan to go-gin (same repo, duplicate default entry).
